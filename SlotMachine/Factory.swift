...
//  SlotMachine
//
//  Created by Miguel Angel Moreno Armenteros on 22/10/14.
...
class Factory {
    ...
    class func createSlots(containers numberOfContainers:Int, slots numberOfSlots:Int) -> [[Slot]] {
        ...
        for var containerNumber = 0; containerNumber < numberOfContainers; containerNumber++ {
            ...
            for var slotNumber = 0; slotNumber < numberOfSlots; ++slotNumber {
                let slot = self.createSlot(slotArray)
